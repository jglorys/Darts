...
<div class="col-12 p-3" id="body-wrapper">
    <section class="col-12 d-flex justify-content-center align-items-center">
        <div class="col-8 d-flex justify-content-around align-items-center" style="height: 90vh;">
            <button class="btn funcBtn1" onclick="movePage('up')">RAISE<br>THE<br>SCORE<br></button>
            <button class="btn funcBtn1" onclick="movePage('down')">LOWERING<br>THE<br>SCORE</button>
        </div>
...
<script>
    function movePage(page) {
        ...
        if (page == 'down') {
            location.href = '${pageContext.request.contextPath}/ella/darts/lowering';
        }
    }
